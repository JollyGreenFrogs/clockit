...
class TestUserRegistration:
    ...
    def test_register_duplicate_username(self, test_client, test_user_data, clean_database):
    ...
    def test_register_duplicate_email(self, test_client, test_user_data, clean_database):
