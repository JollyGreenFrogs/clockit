...
class TestTaskEndpoints:
    ...
    def test_create_task_authenticated(self, authenticated_client, test_task_data, clean_database):
...
class TestUserDataIsolation:
    ...
    def test_task_isolation_between_users(self, test_client, test_task_data, clean_database):
...
class TestTimeEntryEndpoints:
    ...
    def test_add_time_entry_authenticated(self, authenticated_client, clean_database):
        ...
        if task_response.status_code == status.HTTP_200_OK:
            ...
            response = authenticated_client.post(f"/tasks/Test Task for Time Entry/time", json=time_entry_data)
