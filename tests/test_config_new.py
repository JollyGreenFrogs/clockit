...
class TestBasicConfiguration:
    ...
    def test_database_type_default(self):
        ...
        assert Config.DATABASE_TYPE in ['postgres', 'file']  # Allow both during transition
...
class TestDatabaseConfiguration:
    ...
    def test_database_url_generation_postgres(self):
        ...
        with patch.dict(os.environ, {
            ...
            expected_url = "postgresql://clockit_user:password123@localhost:5432/clockit_db"
    ...
    def test_production_missing_secret_key(self):
        ...
        try:
            ...
            if hasattr(config.Config, 'SECRET_KEY'):
                ...
                assert config.Config.SECRET_KEY is None or len(config.Config.SECRET_KEY) >= 32
